...
from housing.constant import *   # to get all constant defined in the constant file
...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
            try:
                artifact_dir = self.training_pipeline_config
                data_ingestion_artifacts_dir = os.path.join(
                    artifact_dir,
                    DATA_INGESTION_ARTIFACT_DIR,
                    self.time_stamp
                )
                data_ingestion_info = self.config_info.config_info[DATA_INGESTION_ARTIFACT_DIR]
